...
<Container>
  <Box>
    ...
    <Text>
      ...
      <Link href="https://theme-ui.com/getting-started" target="_blank" rel="noopener">
        Theme-UI
      </Link>
...
<Heading as="h2" variant="styles.h2" sx={{ color: 'secondaryDark' }}>
  BumHub Components
</Heading>
...
<Label htmlFor="bum-ui-input">
  Input
  <Input id="bum-ui-input" placeholder="Bums" />
</Label>
...
<Label htmlFor="bum-ui-select">
  Select
  <Select id="bum-ui-select">
    <option>Option 1</option>
    <option>Option 2</option>
    <option>Option 3</option>
  </Select>
