  ...
  return (
	...
	C373.2,217.2,373.1,212,369.5,211.6z"
		...
		C282.2,165.9,299.3,129.1,297.3,87.9z"
          ...
          <path fill={colors.skin[tone].light} d="M60.7,46.9c0,0,118.4,38.6,223.5-12C282.9,35,60.7,46.9,60.7,46.9z" />
          <path fill={colors.skin[tone].mid} d="M142.8,156.1c-3.8,0-3.8,6,0,6C146.6,162.1,146.6,156.1,142.8,156.1z" />
          <path fill={colors.skin[tone].mid} d="M162.7,138.9c-3.8,0-3.8,6,0,6C166.5,144.8,166.5,138.9,162.7,138.9z" />
          <path fill={colors.skin[tone].mid} d="M164,157.5c-2.1,0-2.1,3.3,0,3.3C166.2,160.8,166.2,157.5,164,157.5z" />
          <path fill={colors.skin[tone].mid} d="M124.1,149.5c-3.8,0-3.8,6,0,6C128,155.4,128,149.5,124.1,149.5z" />
          <path fill={colors.skin[tone].mid} d="M213.3,144.2c-3.8,0-3.8,6,0,6C217.1,150.1,217.1,144.2,213.3,144.2z" />
          <path fill={colors.skin[tone].mid} d="M202.6,125.6c-3.8,0-3.8,6,0,6C206.4,131.5,206.4,125.6,202.6,125.6z" />
          <path fill={colors.skin[tone].mid} d="M181.3,128.2c-3.8,0-3.8,6,0,6C185.2,134.2,185.2,128.2,181.3,128.2z" />
          <path fill={colors.skin[tone].mid} d="M174.7,150.8c-3.8,0-3.8,6,0,6C178.5,156.8,178.5,150.8,174.7,150.8z" />
          <path fill={colors.skin[tone].mid} d="M110.8,160.1c-3.8,0-3.8,6,0,6C114.7,166.1,114.7,160.1,110.8,160.1z" />
          <path fill={colors.skin[tone].mid} d="M68.3,134.9c-3.8,0-3.8,6,0,6C72.1,140.8,72.1,134.9,68.3,134.9z" />
          <path
            fill={colors.skin[tone].mid}
		...
		c0-0.4,0-0.9,0-1.3C78.2,119.5,77.3,118.5,76.2,118.6z"
          />
          <path fill={colors.skin[tone].mid} d="M61.6,112.3c-3.8,0-3.8,6,0,6C65.4,118.2,65.4,112.3,61.6,112.3z" />
          <path fill={colors.skin[tone].mid} d="M78.9,142.8c-3.8,0-3.8,6,0,6C82.7,148.8,82.7,142.8,78.9,142.8z" />
          <path fill={colors.skin[tone].mid} d="M222.6,162.8c-3.8,0-3.8,6,0,6C226.4,168.7,226.4,162.8,222.6,162.8z" />
          <path fill={colors.skin[tone].mid} d="M227.9,141.5c-3.8,0-3.8,6,0,6C231.7,147.5,231.7,141.5,227.9,141.5z" />
          <path fill={colors.skin[tone].mid} d="M242.5,162.8c-3.8,0-3.8,6,0,6C246.3,168.7,246.4,162.8,242.5,162.8z" />
          <path fill={colors.skin[tone].mid} d="M258.5,144.2c-3.8,0-3.8,6,0,6C262.3,150.1,262.3,144.2,258.5,144.2z" />
          <path fill={colors.skin[tone].mid} d="M243.8,141.6c-2,0-2,3,0,3C245.8,144.7,245.8,141.6,243.8,141.6z" />
          <path fill={colors.skin[tone].mid} d="M279.8,134.9c-3.8,0-3.8,6,0,6C283.6,140.8,283.6,134.9,279.8,134.9z" />
          <path fill={colors.skin[tone].mid} d="M266.5,154.8c-3.8,0-3.8,6,0,6C270.3,160.8,270.3,154.8,266.5,154.8z" />
          <path fill={colors.skin[tone].mid} d="M282.4,125.6c-3.8,0-3.8,6,0,6C286.2,131.5,286.3,125.6,282.4,125.6z" />
          <path
