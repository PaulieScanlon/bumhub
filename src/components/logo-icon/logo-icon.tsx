...
export const LogoIcon: FunctionComponent<ILogoIconProps> = ({ sx }) => {
  return (
    <Box sx={{ width: '24px', height: '24px', ...sx }}>
      <svg version="1.0" x="0px" y="0px" viewBox="0 0 32 32" width="100%" height="100%">
        <g>
          <polyline points="4.13 4.24 4.13 4.24 4.13 4.24" />
          <path
