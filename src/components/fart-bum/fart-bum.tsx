    ...
    <Box sx={{ margin: '0 auto', ...sx }}>
      <svg version="1.0" x="0px" y="0px" viewBox="0 0 410 400" width="100%" height="100%">
		...
		c11.4-1.6,23.6-4.5,36.3-8.6c33.9-11,58.6-36,71.5-72.4c19.6-55.2,7.8-128.7-30.1-187.2l-10.1-15.7l-0.9,0L80.3,91.5z"
          ...
          />
          <path fill={colors.skin[tone].mid} d="M287,293.8c-2,0.4-3.9,0.7-5.7,1.1C283.1,294.5,285.1,294.2,287,293.8z" />
          <path
            fill={colors.skin[tone].mid}
            d="M322.9,282.1c-0.6,0.3-1.2,0.7-1.9,1C321.6,282.8,322.2,282.5,322.9,282.1z"
          />
          <path fill={colors.skin[tone].mid} d="M326,280.4c-0.6,0.4-1.2,0.7-1.8,1C324.8,281.1,325.4,280.7,326,280.4z" />
          <path
            fill={colors.skin[tone].mid}
		...
		C238,218.1,246.9,213.8,256.4,211.3z M98.5,274.6c1.6,10.1-14.8,12.8-16.5,2.6C80.4,267,96.9,264.4,98.5,274.6z"
          ...
          />
          <path fill={colors.skin[tone].mid} d="M261,296.7c-2.3,0-4.4,0-6.5-0.2C256.6,296.6,258.8,296.7,261,296.7z" />
          <path
            fill={colors.skin[tone].mid}
          ...
          />
          <path fill={colors.skin[tone].mid} d="M345.4,264c-0.6,0.7-1.3,1.5-2,2.2C344.1,265.5,344.7,264.8,345.4,264z" />
          <path
            fill={colors.skin[tone].mid}
          ...
          />
          <path fill={colors.skin[tone].mid} d="M356,248.8c-0.5,0.9-1,1.8-1.5,2.6C355,250.6,355.5,249.7,356,248.8z" />
          <path
            fill={colors.skin[tone].mid}
            d="M354.1,251.9c-0.6,0.9-1.2,1.9-1.8,2.8C353,253.8,353.6,252.9,354.1,251.9z"
          />
          <path fill={colors.skin[tone].mid} d="M352.2,255c-2,3-4.2,5.9-6.5,8.6C348.1,260.9,350.2,258,352.2,255z" />
          <path
            fill={colors.skin[tone].mid}
